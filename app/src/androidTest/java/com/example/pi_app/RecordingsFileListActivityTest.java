...
public class RecordingsFileListActivityTest {


    @Rule
    public IntentsTestRule<RecordingsFileListActivity> intentsTestRule =
            new IntentsTestRule<>(RecordingsFileListActivity.class);
    ...
    public void testListItemDownload() {
        onData(anything()).inAdapterView(withId(R.id.recordingsListView)).atPosition(0).perform(click());
